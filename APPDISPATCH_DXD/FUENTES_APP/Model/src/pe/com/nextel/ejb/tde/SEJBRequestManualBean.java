...
import pe.com.nextel.dao.tde.RequestManualDAO;
...
public class SEJBRequestManualBean implements SessionBean {
    ...
    public HashMap getLineaProductoListByIdsolucion(DominioBean solucionNegocio) throws SQLException,
                                                                                        Exception {
        return objRequestManualDAO.getLineaProductoListByIdsolucion(solucionNegocio);
    }

    public HashMap getProductoListByLineaproductoid(DominioBean dominioBean) throws SQLException,
                                                                                    Exception {
        return objRequestManualDAO.getProductoListByLineaproductoid(dominioBean);
    }

    public HashMap getMotivosListByUserLogin(String userLogin) throws SQLException,
                                                                      Exception {
        return objRequestManualDAO.getMotivosListByUserLogin(userLogin);
    }

    public HashMap saveRequestManual(RequestManualBean requestManualBean,
                                     List listaDetailRequestManual) throws SQLException,
                                                                           Exception {
        return objRequestManualDAO.saveRequestManual(requestManualBean,
                                                     listaDetailRequestManual);

    }

    public HashMap getRepuestosList(DominioBean solucionNegocio) throws SQLException,
                                                                        Exception {
    ...
    public StockBean validarStock(StockBean stockBean) throws SQLException,
                                                              Exception {
        return objRequestManualDAO.validarStock(stockBean);
    }

    public HashMap obtenerFlagValidarProductosAndAccesorio(int lineaProducto) throws SQLException,
                                                                                     Exception {
