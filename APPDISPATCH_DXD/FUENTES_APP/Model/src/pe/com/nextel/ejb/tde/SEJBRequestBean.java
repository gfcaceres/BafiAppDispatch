...
import pe.com.nextel.dao.tde.RequestDAO;
...
public class SEJBRequestBean implements SessionBean {
    ...
    public HashMap doSaveRequest(RequestHashMap objHashMap) {
        System.out.println("--SEJBRequestTDE doSaveRequest--");
    System.out.print("Entro EJB Bean Class");
        ...
        try {
            ...
            try {     
                ...
                System.out.println("SEJBRequestBeanTDE/doSaveRequest/insRequest/->" + (String) hshResult.get("strMessage"));
  ...
  public HashMap updGenerateDoc(long lngrequestId,String strLogin)throws  SQLException, Exception {
      System.out.println("INICIO SEJBRequestBeanTDE updGenerateDoc: lngrequestId: " + lngrequestId + ", strLogin: " + strLogin );
  ...
  public HashMap saveRequestOl(long lngRequestolid,long lngReqolstatusid, long lngRequestolitemid,
      ...
      System.out.println("----INICIO SEJBRequestBeanTDE - saveRequestOl lngRequestolid: " + lngRequestolid + ", lngReqolstatusid: " + lngReqolstatusid
                         ...
                         + ", strProductStatus: " + strProductStatus + ", strReason: " + strReason + ", motivoId: " + motivoId + ", subMotivoId: " + subMotivoId 
                         + ", detalleId: " + detalleId + ", comentario: " + comentario + ", ordenId: " + ordenId);
  ...
  public HashMap getSIM(String imei, String avchOrigin)throws  SQLException, Exception {
      System.out.println("----INICIO SEJBRequestBean getSIM param: " + imei + "----, avchOrigin: "+avchOrigin);
      return objRequestDAO.getSIM(imei, avchOrigin);
  }
  ...
  public HashMap validarSim(String an_nprequestolid)throws  SQLException, Exception {
    ...
    public HashMap validateModelCondition2(long lngRequestolid,
        ...
        System.out.println("INICIO SEJBRequestBean validateModelCondition2: lngRequestolid: " + lngRequestolid + ", strImei: " + strImei + ", strCondicion: " + strCondicion + ", lrequestStateCod: " + lrequestStateCod + ", strAccion: " + strAccion);
    ...
    public HashMap updateModelCondition(long lngRequestolid,
        ...
        System.out.println("INICIO SEJBRequestBean updateModelCondition: lngRequestolid: " + lngRequestolid + ", strImei: " + strImei + ", strCondicion: " + strCondicion + ", lrequestStateCod: " + lrequestStateCod + ", strAccion: " + strAccion);
   ...
   //INICICO JGABRIEL REQ-0123
    public String validateSubInventoryCode(String strSubInventoryCode,String numRequest) throws Exception, SQLException {
        System.out.println("INICIO SEJBRequestBeanTDE validateSubInventoryCode strSubInventoryCode: " + strSubInventoryCode + ", numRequest: " + numRequest);
    ...
    public String validateModelResquested(String strImei, String strNumRequest) throws Exception, SQLException {
        System.out.println("INICIO SEJBRequestBeanTDE validateModelResquested strImei: " + strImei + ", strNumRequest: " + strNumRequest);
    ...
    //portega est-1343
    public int getFlagRequestOlTde(long requestId) throws SQLException, Exception{
        return objRequestDAO.getFlagRequestOlTde(requestId);
    }
}