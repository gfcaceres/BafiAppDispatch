...
<%@ page import="pe.com.nextel.servlet.RequestServletTDE" %>
...
<%@ page import="pe.com.nextel.service.tde.RequestService"%>
  ...
  System.out.println("Sesión capturada después del request : " + strSessionSearchRequestListId );
    ...
    if(portalSessionBean3==null) {
      ...
      if(param.equals("BUSQUEDA")){
          System.out.println("BUSQUEDA EST-1343: JSP inbox");
          ...
          new RequestServletTDE().buscarSolicitudes(request,response);
          param = "BUSQUEDA";        
          ...
          new RequestServletTDE().loadListRequest(request,response);        
  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function fxRequestDetail(strRequesrId){
            ...
            formulario.action = "<c:out value="${pageContext.request.contextPath}"/>/generalservletTDE?METHOD=SEND_REQUEST&strRequesrId="+strRequesrId+"&"+"strBuilding="+strBuilding;                                                                                                              
            formulario.submit();          
        }  
