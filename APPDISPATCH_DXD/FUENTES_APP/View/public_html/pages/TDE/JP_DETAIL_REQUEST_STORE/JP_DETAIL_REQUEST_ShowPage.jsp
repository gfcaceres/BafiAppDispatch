...
<%@ page import="pe.com.nextel.service.tde.GeneralService"%>
<%@ page import="pe.com.nextel.servlet.GeneralServletTDE"%>
...
<%
  ...
  try{
    ...
    new GeneralServletTDE().loadRequestDetail(request,response);
  ...
  function generateDoc(){
        ...
        if(validarListaIMEI()){
            ...
            $.ajax({
                cache:false,
                type: "POST",   
                url: '<c:out value="${pageContext.request.contextPath}"/>/generalservletTDE',
