...
import pe.com.nextel.ejb.tde.SEJBRequestManualRemote;
import pe.com.nextel.ejb.tde.SEJBRequestManualRemoteHome;
...
public class RequestManualService extends GenericService{
  ...
  public static SEJBRequestManualRemote getSEJBRequestManualRemote() {
    try {
        ...
        final SEJBRequestManualRemoteHome remoteHome = (SEJBRequestManualRemoteHome) PortableRemoteObject.narrow(context.lookup("SEJBRequestManualTDEDispatch"), SEJBRequestManualRemoteHome.class);
